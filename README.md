...
> **Status — v2.1.2 MVP release line.** Reader, EPUB import, streaming translation, AI read-aloud, MenuBar popup, vocabulary list, and side-by-side dual-column layout have all shipped. Technical preview builds are distributed as Developer ID signed, Apple-notarized DMGs through R2 and Homebrew Cask.
...
[Download Lexi 2.1.2](https://pub-971ee03b82ad411a9bb26c62a06ca755.r2.dev/lexi/releases/2.1.2/Lexi-2.1.2-installer.dmg)
...
v2.1.2 is the current MVP technical preview release line: PR 1–10 have landed, follow-up fixes, OpenAI TTS support, read-aloud UI iteration, and Reader cross-paragraph selection are merged, and installable Developer ID signed, Apple-notarized DMG builds are available through R2 and `lynxlangya/tap`.
