...
struct GatsbyFixtureParagraph: Identifiable, Equatable, Sendable {
    var id: String { en }
    let en: String
    let zh: String
}

struct GatsbyFixtureChapter: Identifiable, Equatable, Sendable {
    var id: String { n }
    let n: String
    let title: String
    let paras: [GatsbyFixtureParagraph]
}
...
enum GatsbyFixture {
    ...
    static let chapters: [GatsbyFixtureChapter] = [
        GatsbyFixtureChapter(
            n: "I",
            title: "In my younger and more vulnerable years",
            paras: [
                GatsbyFixtureParagraph(
