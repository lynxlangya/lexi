...
> **状态 — v2.0.1 MVP release line。** 阅读器、EPUB 导入、流式翻译、AI 朗读、MenuBar 浮窗、生词本、左右双栏布局都已上线。当前技术预览包通过 GitHub Releases 和 Homebrew Cask 分发。
...
v2.0.1 是当前 MVP 技术预览版本线：计划中的 PR 1–10 已合入，后续修复和朗读迭代也已落地，并已通过 GitHub Releases 和 `lynxlangya/tap` 提供可安装构建包。
