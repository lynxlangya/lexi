// chapters.jsx — Gatsby chapters (public domain, 1925) for the prototype.
// Real text per chapter, with hand-written ZH translations.

const CHAPTERS = [
  {
    n: 'I', title: 'In my younger and more vulnerable years',
    paras: [
  ...
  {
    n: 'II', title: 'About half way between West Egg and New York',
    paras: [
  ...
  {
    n: 'III', title: 'There was music from my neighbor\u2019s house',
    paras: [
  ...
  {
    n: 'V', title: 'When I came home to West Egg',
    paras: [
  ...
  {
    n: 'VI', title: 'About this time an ambitious young reporter',
    paras: [
  ...
  {
    n: 'VII', title: 'It was when curiosity about Gatsby was at its highest',
    paras: [
  ...
  {
    n: 'VIII', title: 'I couldn\u2019t sleep all night',
    paras: [
  ...
  {
    n: 'IX', title: 'After two years I remember',
    paras: [
...
// A tiny "dictionary" for the prototype — words that get full word-card
// treatment when selected. Anything else falls back to the sentence card.
const DICT = {
  vulnerable: {
    ipa: '/ˈvʌlnərəbl/',
    senses: [
      { pos: 'adj.', en: 'exposed to harm; emotionally open and unguarded', zh: '易受伤害的；情感上不设防的、脆弱的' },
  ...
  desolate: {
    ipa: '/ˈdɛsələt/',
    senses: [
      { pos: 'adj.', en: 'bleak, empty, devoid of life',     zh: '荒凉的、空寂的、了无生气的' },
      { pos: 'v.',   en: 'to make wretched or comfortless',  zh: '使凄凉、使悲惨' },
    ],
  },
  grotesque: {
    ipa: '/ɡroʊˈtɛsk/',
    senses: [
      { pos: 'adj.', en: 'comically or repulsively ugly or distorted', zh: '怪诞的、丑陋扭曲的' },
    ],
  },
  ravages: {
    ipa: '/ˈrævɪdʒɪz/',
    senses: [
      { pos: 'n.',   en: 'severely damaging or destructive effects', zh: '破坏，蹂躏；造成的严重损害' },
    ],
  },
  reserved: {
    ipa: '/rɪˈzɜːrvd/',
    senses: [
      { pos: 'adj.', en: 'slow to reveal emotion or opinions; restrained',  zh: '矜持的、寡言的、有所保留的' },
      { pos: 'adj.', en: 'kept for a particular person or purpose',          zh: '预订的、保留的' },
    ],
  },
  privy: {
    ipa: '/ˈprɪvi/',
    senses: [
      { pos: 'adj.', en: 'sharing in the knowledge of something secret',    zh: '知情的，私下知晓内情的' },
    ],
  },
  bootlegger: {
    ipa: '/ˈbuːtˌlɛɡər/',
    senses: [
      { pos: 'n.',   en: 'a person who makes, distributes, or sells alcohol illegally', zh: '私酒贩子，走私贩' },
    ],
  },
  bewitched: {
    ipa: '/bɪˈwɪtʃt/',
    senses: [
      { pos: 'adj.', en: 'under the influence of magic; enchanted',          zh: '中了魔法的、被迷住的' },
    ],
  },
  obscure: {
    ipa: '/əbˈskjʊr/',
    senses: [
      { pos: 'adj.', en: 'not clearly understood or expressed',              zh: '晦涩的；不明显的；鲜为人知的' },
      { pos: 'v.',   en: 'to keep from being seen',                          zh: '遮蔽，使难以看清' },
    ],
  },
  sulkily: {
    ipa: '/ˈsʌlkɪli/',
    senses: [
      { pos: 'adv.', en: 'in a moody, sullen manner',                        zh: '愠怒地、闷闷不乐地' },
    ],
  },
};

Object.assign(window, { CHAPTERS, DICT });
